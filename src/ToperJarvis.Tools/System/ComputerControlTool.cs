...
public sealed class ComputerControlTool : IJarvisTool
{
    ...
    public AIFunction AsAIFunction() =>
        AIFunctionFactory.Create(Execute, Name,
            ...
            "click, right_click, move (x,y), scroll (amount).");

    [Description("Steruje myszą/klawiaturą.")]
    private string Execute(
        [Description("Akcja: type, press, hotkey, click, right_click, move, scroll.")] string action,
        [Description("Tekst do wpisania (dla type) lub nazwa klawisza/skrótu (dla press/hotkey).")]
        string? text = null,
